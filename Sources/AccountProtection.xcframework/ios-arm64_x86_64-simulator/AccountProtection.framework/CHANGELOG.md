...
* feat: Added call detector and dynamic device orientation support.
* feat: Refactor some API functions names and parameters.
* feat: Added new API function - logPageLoad.
* feat: Increase sampling rate for touch
